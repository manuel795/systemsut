...
$user="Manuel Isaias Marin Trejo";
?>
<!DOCTYPE html>
<html lang="es-MX">
<head>
...
<header>
    <div class="encabezado">           
                    <div class="logo"> 
                        ...
                        <div class="name">                            
                            <p class="User"><span style="color:yellow;">Bienvenid@&nbsp;Administrador: </span> &nbsp; <strong><?php echo $user; ?></strong></p>                           
                        </div>
                    </div> 
                    <div class="enlaces">
                        <nav class="navbar">
                            <ul> 
                                ...
                                <li>
                                    <a href="" data-bs-toggle="modal" data-bs-target="#altaFalta">Registro de Faltas</a>
                                </li> 
                                <li>
                                    <a href="" data-bs-toggle="modal" data-bs-target="#consultaPersonal">Consulta General</a>
                                </li> 
                                <li>
                                    <a href="" data-bs-toggle="modal" data-bs-target="#consultaFalta">Faltas General</a>
                                </li> 
                                <li>
...
<body>
    <div class="container">
        ...
        <div class="datos" id="datosG">
         <!--  INFORMACIÓN DE LA BUSQUEDA RÁPIDA-->
        </div>

        <?php//interfaces de capturas
    ...
    <script> 
        ...
        async function cargarDatos() {
            try {
                // Realiza una solicitud a la API (getData.php)
